...
if($_REQUEST['eliminacion']==1) {//confirmacion de insercion  
	$campos="estado_cam='2'";
	$error=editar("campeonato",$campos,'cod_cam',$eli_codigo); 
	if ($error >=1)
...
if(!empty($busquedas)) { #codigo para buscar 
	...
	$where=" where estado_cam = 3 and $busquedas";
}#codigo para buscar 
else{
	$where=" where estado_cam = 3";
}
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_cierre.php">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td> 
						  <?php if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_cierre.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
					  	  <?php } ?></td>
                          ...
                          <td valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_cam">NOMBRE</option>
                            <option value="ver_cam">VERSION</option>
                    ...
                    <tr>
                      <td><table width="100%" border="0"  cellpadding="0">
                        <tr>
                          ...
                          <td  class="ctablasup">VERSION</td>
                          <td  class="ctablasup">LOCALIDAD</td>
                          <td  class="ctablasup">RESE&Ntilde;A</td>
                          <td  class="ctablasup">OPCIONES</td>
                        </tr>
						<?php 
						
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_cierre.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_cam' action='man_cierre.php'>  ";
              echo "<td>$db->nom_cam</td>";
						  Echo "<td>$db->ver_cam</td> ";
              Echo "<td>$db->nom_loc</td> ";
              echo "<td>$db->rese_cierre</td>";
              Echo "<td aling='center' >"; 
							echo "<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_cam'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.png' alt='Editar Registro' style='cursor:pointer'  onclick='document.forma_$db->cod_cam.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.png'   /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.png'  alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_cam) /></td> ";
							else
...
<form name="forma" method="post" action="con_cierre.php">
