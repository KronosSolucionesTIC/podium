...
if($_REQUEST['eliminacion']==1) {//confirmacion de insercion  
	$campos="estado_mcosto='2'";
	$error=editar("m_costos",$campos,'cod_mcosto',$eli_codigo); 
	if ($error >=1)
...
if(!empty($_REQUEST['busquedas'])) {
  if($_REQUEST['campo'] == 'nombre'){
    ...
    $where="having $busquedas and estado_mcosto = 1";
  } 
  else{
    $busquedas=reemplazar_1($busquedas);
    $where="where $busquedas and estado_mcosto = 1";
  }
}
else{
  $where="where estado_mcosto = 1";
}
...
$where ORDER BY cod_mcosto DESC";
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_cuotas.php">
                  <table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" >
                    <tr>
                      <td><table width="90%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td> 
						  <?php if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_cuotas.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
					  	  <?php } ?></td>
                          ...
                          <td valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="tot_mcosto">TOTAL</option>
                    ...
                    <tr>
                      <td><table width="90%" border="0"  cellpadding="0">
						...
						echo "<tr style='display:none'><td ><form name='forma_0' action='man_cuotas.php'>";
						echo "  </form> </td></tr>  ";						  
						$estilo="ctablablanc";
						$estilo="ctablagris";
						...
						while($db->next_row()) {
							...
							echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_mcosto' action='man_cuotas.php'>  ";
              echo "<td>$db->nombre</td>";
						  echo "<td>$db->tot_mcosto</td> ";
              echo "<td aling='center' >"; 
							echo 	"<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_mcosto'>";
							if ($editar==1)
							 	echo "<img src='imagenes/icoeditar.png' alt='Editar Registro' style='cursor:pointer'  onclick='document.forma_$db->cod_mcosto.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.png'   /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.png'  alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_mcosto) /></td> ";
							else
...
<form name="forma" method="post" action="con_cuotas.php">
