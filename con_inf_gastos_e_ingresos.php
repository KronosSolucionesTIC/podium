...
function abrir() {	 // cierre normal	
	...
	else 
	{
		...
		imprimir_inf("inf_gastos_e_ingresos.php",'0&fec_ini='+fec_ini+'&fec_fin='+fec_fin,'mediano');
	}
}
</script>
    ...
    <td valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
        <tr>
          <td><table width="100%" border="0"  cellpadding="0" align="center">
              <tr>
                <td colspan="4"  class="ctablasup" >INFORME DE GASTOS E INGRESOS</td>
              </tr>
              <?php 
						$estilo="ctablablanc";
						$estilo="ctablagris";					
              ...
              <tr>
                ...
                <td class="ctablablanc" ><input name="fecha" type="text" class="textotabla01" id="fec_ini" readonly  />
