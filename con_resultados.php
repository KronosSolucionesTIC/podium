...
if($_REQUEST['eliminacion']==1) {//confirmacion de insercion  
  $campos="estado_res='2'";
  $error=editar("m_resultado",$campos,'cod_res',$eli_codigo); 
  if ($error >=1)
...
<tr>
<td valign="top" >
<form id="forma_total" name="forma_total" method="post" action="man_resultados.php">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td> 
              <?php if ($insertar==1) {?>
                <img src="imagenes/agregar.png"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_resultados.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
                <?php } ?></td>
              ...
              <?php } ?>
                          ...
                          <td valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                             ...
                             <option value="nom_cam">CAMPEONATO</option>
                             <option value="nom_cam">EQUIPO 1</option>
                             <option value="nom_cam">EQUIPO 2</option>
              ...
              <img src="imagenes/lupa.png" style="cursor:pointer"  onClick="buscar()"/></td>
                    ...
                    <tr>
                      <td><table width="100%" border="0"  cellpadding="0">
                        <tr>
                          <td  class="ctablasup">CAMPEONATO</td>
                          <td  class="ctablasup">EQUIPO 1</td>
                          <td  class="ctablasup">MARCADOR</td>
                          <td  class="ctablasup">EQUIPO 2</td>
                          <td  class="ctablasup">MARCADOR</td>
                          <td  class="ctablasup" >OPCIONES</td>
                        </tr>
            <?php 
            
            echo "<tr style='display:none'><td ><form name='forma_0' action='man_resultados.php'>";
            echo "  </form> </td></tr>  ";              
            $estilo="ctablablanc";
            $estilo="ctablagris";
            ...
            while($db->next_row()) {
              ...
              echo "<tr class='$estilo' $cambio_celda> <form name='forma_$db->cod_res' action='man_resultados.php'>  ";
              echo "<td>$db->nom_cam</td>";

              //CONSULTA EL EQUIPO 1
              $dbe1 = new database();
              ...
              echo "<td align='center'>$dbe1->nom_equi</td>";
              echo "<td align='center'>$db->equi1_mar</td>";
              ...
              echo "<td align='center'>$dbe2->nom_equi</td>";
              echo "<td align='center'>$db->equi2_mar</td>";

              echo "<td aling='center' >"; 
              echo  "<table width='100%' border='0' cellspacing='0' cellpadding='0'>";
                            echo  " <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_res'>";
              if ($editar==1)
                echo "<img src='imagenes/icoeditar.png' alt='Editar Registro' style='cursor:pointer'  onclick='document.forma_$db->cod_res.submit()'/></td>";
              else 
                echo "<img src='imagenes/e_icoeditar.png'   /></td>";
                            echo  "<td align='center'>";
              if ($eliminar==1)
                echo"<img src='imagenes/icoeliminar.png'  alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_res) /></td> ";
              else
...
<form name="forma" method="post" action="con_resultados.php">
