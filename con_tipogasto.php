...
if(!empty($busquedas)) { #codigo para buscar 
	...
	$where=" where estado_tgas = 1 and $busquedas";
}#codigo para buscar 
else{
	$where=" where estado_tgas = 1";
}
...
<form id="forma_total" name="forma_total" method="post" action="man_tipogasto.php">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td> 
						  <?php if ($insertar==1) {?>
					  	  <img src="imagenes/agregar.png"  alt="Nuevo Registro" style="cursor:pointer" onClick="location.href='man_tipogasto.php?codigo=0&editar=<?php echo $editar?>&insertar=<?php echo $insertar?>&eliminar=<?php echo $eliminar?>'"/>
					  	  <?php } ?></td>
                          ...
                          <td valign="middle"><select name="campos" class="textfieldlista" id="campos" >
                            ...
                            <option value="nom_gas">TIPO GASTO</option>
              ...
              echo 	" <tr>  <td align='center'> <input type='hidden' name='codigo' value='$db->cod_gas'>";
							if ($editar==1)
							  echo "<img src='imagenes/icoeditar.png' alt='Editar Registro' style='cursor:pointer'  onclick='document.forma_$db->cod_gas.submit()'/></td>";
							else 
								echo "<img src='imagenes/e_icoeditar.png'   /></td>";
                            echo 	"<td align='center'>";
							if ($eliminar==1)
								echo"<img src='imagenes/icoeliminar.png'  alt='Eliminar Registro' height='16' style='cursor:pointer' onclick=confirmar($db->cod_gas) /></td> ";
							else
